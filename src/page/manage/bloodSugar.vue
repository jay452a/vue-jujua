...
export default {
  data() {
    return {
      ...
      testTime: '',
      listData: [
        /*{ param: '7.2mmol/L', testTime: '2018-3-12: 19:00:00', status: '正常' },
        { param: '7.2mmol/L', testTime: '2018-3-12: 19:00:00', status: '正常' },
        { param: '7.2mmol/L', testTime: '2018-3-12: 19:00:00', status: '正常' },
        { param: '7.2mmol/L', testTime: '2018-3-12: 19:00:00', status: '正常' },
        { param: '7.2mmol/L', testTime: '2018-3-12: 19:00:00', status: '正常' },
  ...
  methods: {
    loadData() {
      ...
      getHealthData(params).then(res => {
        ...
        if(this.pageNo === 1) {
          this.sugar = res[0].BloodSugar + 'mmol/L'
          this.status = res[0].JudgeResult
          this.testTime = res[0].CreateDate
          this.log = res[0].BloodsugarTypeShow
        }
        const data = []
        res.map(res => {
          data.push({ param: {sugar:`${res.BloodSugar}mmol/L`}, testTime: res.CreateDate, status: res.JudgeResult})
        })
